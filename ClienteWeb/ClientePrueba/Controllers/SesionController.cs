...
namespace ClientePrueba.Controllers
{
    public class SesionController : Controller
    {
        ...
        {
            List<ClienteWeb.CUsuarios.Usuario> lista = c.verTodos();
            ClienteWeb.CUsuarios.Usuario usuario = null;
        ...
        public ActionResult Recuperacion(string Clave, string id)
        {
            ...
            ClienteWeb.CUsuarios.Usuario usuario = c.encontrarUno(id);
        ...
        public RedirectToRouteResult cambiarPass(ClienteWeb.CUsuarios.Usuario usuario)
        {
            ClienteWeb.CUsuarios.Usuario user = c.encontrarUno(usuario.Id.ToString());
