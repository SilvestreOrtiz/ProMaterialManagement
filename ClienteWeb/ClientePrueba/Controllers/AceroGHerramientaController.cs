...
namespace ClientePrueba.Controllers
{
    public class AceroGHerramientaController : Controller
    {
        ...
        {
            string ID = id_acerogh.ToString();
            ClienteWeb.MaterialAceroGH.AceroGHerramienta acerogh = C.encontrarUno(ID);
            C.eliminar(acerogh);
            RedirectToAction("Consultar", "AceroGHerramienta");
        }
        [HttpPost]
        public RedirectToRouteResult subir(ClienteWeb.MaterialAceroGH.AceroGHerramienta l)
        {
            C.subir(l);
        ...
        public RedirectToRouteResult Editar(ClienteWeb.MaterialAceroGH.AceroGHerramienta l)
        {
            C.editar(l);
            return RedirectToAction("Consultar", "AceroGHerramienta");
        }
