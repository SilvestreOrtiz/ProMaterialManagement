...
namespace ClientePrueba.Controllers
{
    public class AceroInoxidableController : Controller
    {
        ...
        {
            string ID = id_aceroInox.ToString();
            ClienteWeb.MaterialAceroInoxidable.AceroInoxidable aceroinox = C.encontrarUno(ID);
            C.eliminar(aceroinox);
            RedirectToAction("Consultar", "AceroInoxidable");

        }
        [HttpPost]
        public RedirectToRouteResult subir(ClienteWeb.MaterialAceroInoxidable.AceroInoxidable l)
        {
            C.subir(l);
        ...
        public RedirectToRouteResult Editar(ClienteWeb.MaterialAceroInoxidable.AceroInoxidable l)
        {
            C.editar(l);
            return RedirectToAction("Consultar", "AceroInoxidable");
