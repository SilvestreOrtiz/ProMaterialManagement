...
namespace ClientePrueba.Cliente
{
    public class ClienteUsuarios
    {
        ...
        public bool subir(Usuario usuario)
        {
            ...
            //Agregar al usuario
            DataContractJsonSerializer ser = new DataContractJsonSerializer(typeof(ClienteWeb.CUsuarios.Usuario));
        ...
        public ClienteWeb.CUsuarios.Usuario encontrarUno(string id)
        {
            var synClient = new WebClient();
        ...
        //Agrega una fila a la tabla
        public void editar(ClienteWeb.CUsuarios.Usuario usuario)
        {
