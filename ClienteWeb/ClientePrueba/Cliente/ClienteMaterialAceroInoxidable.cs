using ClienteWeb.MaterialAceroInoxidable;
using System;
...
namespace ClientePrueba.Cliente
{
    public class ClienteMaterialAceroInoxidable
    {
        ...
        public void subir(ClienteWeb.MaterialAceroInoxidable.AceroInoxidable aceroinox)
        {

            DataContractJsonSerializer ser = new DataContractJsonSerializer(typeof(ClienteWeb.MaterialAceroInoxidable.AceroInoxidable));
        ...
        public ClienteWeb.MaterialAceroInoxidable.AceroInoxidable encontrarUno(string id_aceroInox)
        {
            var synClient = new WebClient();
            string url = string.Format(BASE_URL + "get/{0}", id_aceroInox);
            var content = synClient.DownloadString(url);
            var json_serializer = new JavaScriptSerializer();
            return json_serializer.Deserialize<ClienteWeb.MaterialAceroInoxidable.AceroInoxidable>(content);

        }

        //Agrega una fila a la tabla
        public void editar(ClienteWeb.MaterialAceroInoxidable.AceroInoxidable aceroinox)
        {
        ...
        public void eliminar(ClienteWeb.MaterialAceroInoxidable.AceroInoxidable aceroinox)
        {
