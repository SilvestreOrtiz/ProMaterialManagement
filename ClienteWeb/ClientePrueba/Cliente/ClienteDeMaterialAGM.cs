...
namespace ClientePrueba.Cliente
{
    public class ClienteDeMaterialAGM
    {
        ...
        public void subir(ClienteWeb.MaterialAceroGM.AceroGMaquinaria acerogm)
        {

            DataContractJsonSerializer ser = new DataContractJsonSerializer(typeof(ClienteWeb.MaterialAceroGM.AceroGMaquinaria));
        ...
        public ClienteWeb.MaterialAceroGM.AceroGMaquinaria encontrarUno(string id_acerogm)
        {
            var synClient = new WebClient();
            string url = string.Format(BASE_URL + "get/{0}", id_acerogm);
            var content = synClient.DownloadString(url);
            var json_serializer = new JavaScriptSerializer();
            return json_serializer.Deserialize<ClienteWeb.MaterialAceroGM.AceroGMaquinaria>(content);

        }

        //Agrega una fila a la tabla
        public void editar(ClienteWeb.MaterialAceroGM.AceroGMaquinaria acerogm)
        {
        ...
        public void eliminar(ClienteWeb.MaterialAceroGM.AceroGMaquinaria acerogm)
        {
